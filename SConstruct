...
for rc_asset_file in rc_asset_files:
    print " -", rc_asset_file
built_source_files.append(env.QtResources('src/rtcolor/ui/qt_assets_rc.py', ['src/rtcolor/ui/qt_assets.qrc', ] + rc_asset_files))
...
for py_file in py_files:
    print ' -', py_file
env.Exe('dist/RT Color Analysis.exe', py_files)
